...
import microservice.controller.chain.WarehouseChain;
...
public class WarehouseFacade {
    // Chains
    private WarehouseChain productImporter;
    private WarehouseChain supplierDeleter;

    // Services
    private final AbsService productService;
    private final AbsService supplierService;
    private final AbsService importBillService;
    private final AbsService importDetailService;
